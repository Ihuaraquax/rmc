...
void TextDisplayer::displayTextToLeft(double X, double Y, std::string text)
{
    char toDisplay[100];
    strcpy(toDisplay, text.c_str());
    al_draw_text(Variables::basicFont, al_map_rgb(255,255,255), X, Y, ALLEGRO_ALIGN_LEFT, toDisplay);
}