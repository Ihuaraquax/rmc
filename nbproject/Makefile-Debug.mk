...
${OBJECTDIR}/AllAllowanceObjects.o: AllAllowanceObjects.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllAllowanceObjects.o AllAllowanceObjects.cpp
...
${OBJECTDIR}/AllLightSources.o: AllLightSources.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllLightSources.o AllLightSources.cpp

${OBJECTDIR}/AllPlans.o: AllPlans.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllPlans.o AllPlans.cpp

${OBJECTDIR}/AllowanceObject.o: AllowanceObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllowanceObject.o AllowanceObject.cpp

${OBJECTDIR}/Animation.o: Animation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Animation.o Animation.cpp
...
${OBJECTDIR}/FlamingPipe.o: FlamingPipe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FlamingPipe.o FlamingPipe.cpp
...
${OBJECTDIR}/LightSource.o: LightSource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LightSource.o LightSource.cpp
...
${OBJECTDIR}/PickUp.o: PickUp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PickUp.o PickUp.cpp

${OBJECTDIR}/Plan.o: Plan.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Plan.o Plan.cpp

${OBJECTDIR}/PlanStep.o: PlanStep.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlanStep.o PlanStep.cpp
...
${OBJECTDIR}/ProjectileModificator.o: ProjectileModificator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProjectileModificator.o ProjectileModificator.cpp
...
${OBJECTDIR}/Skills.o: Skills.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Skills.o Skills.cpp
...
${OBJECTDIR}/Tooltip.o: Tooltip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tooltip.o Tooltip.cpp
